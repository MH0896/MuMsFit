...
public class RemoveTest {
    ...
    public void removeCPA() throws Exception {
        ...
        CreatePlanActivity.uebungen.add(new Uebung("u1", "5", 7, "split1"));
        CreatePlanActivity.uebungen.add(new Uebung("u2", "5", 7, "split1"));
        CreatePlanActivity.uebungen.add(new Uebung("u3", "5", 7, "split2"));
        CreatePlanActivity.uebungen.add(new Uebung("u4", "5", 7, "split2"));
        CreatePlanActivity.uebungen.add(new Uebung("u7", "5", 7, "split2"));
        CreatePlanActivity.uebungen.add(new Uebung("u5", "5", 7, "split1"));
        CreatePlanActivity.uebungen.add(new Uebung("u6", "5", 7, "split2"));
